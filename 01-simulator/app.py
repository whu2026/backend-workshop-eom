...
RABBITMQ_HOST = os.getenv("RABBITMQ_HOST", "rabbitmq-service.luke.svc.cluster.local")
RABBITMQ_PORT = int(os.getenv("RABBITMQ_PORT", "5672"))
RABBITMQ_USER = os.getenv("RABBITMQ_USER", "workshop_user")
RABBITMQ_PASS = os.getenv("RABBITMQ_PASS", "change-me")
...
def publish_to_rabbitmq():
    ...
    while True:
        try:
            ...
            print(f"RabbitMQ is unavailable: {error}. Retrying in 5 seconds.")
            connection = None
            channel = None
            time.sleep(5)
